...
ഞാൻ എല്ലാ മലയാളം സീരിയലുകളും അയച്ചുതരുന്ന ലോകത്തിലെ ഏറ്റവും മികച്ച ബോട്ടുകളിൽ ഒന്നാണ്.
 നിങ്ങൾക്ക് വേണ്ട എല്ലാ സീരിയലുകൾ പേര് ടൈപ്പ് ചെയ്ത് അയച്ചാൽ ഞാൻ സെന്റ് ചെയ്തു തരുന്നതാണ്.

 എങ്ങനെയാണ് സീരിയൽ ലഭിക്കുന്നത് എന്നറിയാൻ താഴെ കാണുന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക.</i></b>"""
...
"""
    ...
    FILE_CAPTION = """<b><a href=https://t.me/AsianetSerialGroupVH>{file_name} </a></b>

<i>ᴘʟᴇᴀsᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪs ꜰɪʟᴇs ᴛᴏ ᴛʜᴇ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇ ᴀɴᴅ ᴄʟᴏsᴇ ᴛʜɪs ᴍᴇssᴀɢᴇ</i>
    
<b>=========== • ✠ • =========== ▫️ ᴄʜᴀɴɴᴇʟ : @AsianetSerialGroupVH ▫️ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : @asianet_surya_zee 
=========== • ✠ • =========== 

<i>COPY RIGHT കാരണം സീരിയൽ GROUP BAN ആവാൻ സാധ്യത ഉള്ളതിനാൽ എല്ലാവരും ഉടൻ ᴍᴀʟʟᴜ-ꜱᴇʀɪᴀʟ ɢʀᴏᴜᴩ ന്റെ WHATSAPP ചാനലിൽ ജോയിൻ ചെയ്യുക. 👇 </i>

‼️Link 👇 https://whatsapp.com/channel/0029VahPgTZCcW4itu3f3e2S</b>"""
...
💖 𝐔𝐏𝐈 𝐈𝐃 : <code>vishnugopika177@okaxis</code>
"""
