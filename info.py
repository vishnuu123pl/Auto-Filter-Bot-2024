...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/bNK.jpg')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001906470657').split()]
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001968355911'))
...
DELETE_TIME = int(environ.get('DELETE_TIME', 1300))
